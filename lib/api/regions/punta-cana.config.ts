...
/**
 * Punta Cana region configuration
 * Coordinates for the Punta Cana beach area, Dominican Republic
 */
export const puntaCanaConfig: RegionConfig = {
  id: 'punta-cana',
  name: 'Punta Cana',
  displayName: 'Punta Cana, DR',
  coordinates: {
    latitude: 18.5819,
    longitude: -68.3689,
  },
